# King Web - Crea tu primera página web con HTML y CSS

## Resumen del curso

Este curso introduce a estudiantes de secundaria a los fundamentos del desarrollo web mediante HTML y CSS. El curso no requiere instalaciones: todas las actividades se realizan desde el navegador usando editores online.
...
Al finalizar el curso, el estudiante habrá creado una página web personal básica con:
...
- Imagen.
- Enlace favorito.
- Estilos con colores, fuente, bordes, espaciado y centrado.
